...
import { initialFilterParams } from './filter.type';
...
const Filter: React.FC = () => {
        ...
        const updatedParams = {
            ...
            brand:
                Array.from(searchParams.entries())
                    ...
                    .map(([, value]) => value) || initialFilterParams.brand,
    ...
    useEffect(() => {
        ...
        console.log('currentParams, params: ', currentParams, params);
